...
const statementInformation = (datastream, afterDate = new Date('1900-01-01')) => {
        ...
        rows.map((row) => {
            ...
            switch (statement[0]) {
                ...
                case '3': { // Sampling information
                    ...
                    if (toDate_1.default(recordingDate) >= afterDate) { // If after date specified in param.
                ...
                case '4': { // Service information
                    ...
                    if (toDate_1.default(serviceDate) >= afterDate) { // If after param date.
                        cow.services.push({
                ...
                case '5': { // Calving
                    ...
                    // Push data to cow.
                    if (toDate_1.default(calvingDate) >= afterDate) { // If param specified - only return if after date.
                        cow.calvings.push({
                ...
                case '7': { // Date of assumed calving
                    ...
                    if (toDate_1.default(assumedCalvingDate) >= afterDate) {
                        cow.calvings.push({
                ...
                case 'M': { // Sold
                    ...
                    if (toDate_1.default(eventDate) >= afterDate) {
