...
exports.herdInformation = void 0;
const toDate_1 = __importDefault(require("../utils/toDate"));
const herdInformation = (datastream) => {
    let herdInfo = {
        address: {},
        nmrInformation: {},
    };
    ...
    rows.map((row) => {
        ...
        switch (information[0]) {
            case '1': {
                ...
                herdInfo = {
                    ...exports.herdInformation,
                    pedigreeBreed,
                    herdPrefix: herdPrefix.trim(),
                    startedRecording: (startedRecording !== '000000') ? toDate_1.default(startedRecording) : null,
                    nmrInformation: {
...
exports.herdInformation = herdInformation;
exports.default = exports.herdInformation;
